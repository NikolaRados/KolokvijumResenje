...
namespace DataAccess.Context
{
    public partial class ChinookContext : DbContext
    {
        ...
        public virtual DbSet<CustomerUseCase> CustomerUseCases { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=IGOR-PC;Initial Catalog=Chinook;Integrated Security=True;");
            }
        }

        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.ApplyConfiguration(new CustomerUseCaseConfiguration());
